 ...
 */
package app.com.ferchofpz.sunshine.data;
...
public class WeatherProvider extends ContentProvider {
    ...
    static UriMatcher buildUriMatcher() {
        ...
        /*
        URIs that our ContentProvider will implement; each one will be used to execute different types of operations against
        the underlying SQL databases.
        The content providers tie each URI type internally to an integer constant. Android provides a UriMatcher to help
        match incoming URIs to the integer constants.
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            ...
            case WEATHER_WITH_LOCATION_AND_DATE:
                //This filter returns a single row => item type
                return WeatherContract.WeatherEntry.CONTENT_ITEM_TYPE;
            case WEATHER_WITH_LOCATION:
                //This filter returns multiple rows => dir type
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        //Notify changes to any ContentObserver
