...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        assertTrue("Failure to insert values",locationRowID != -1);
    ...
    public void testWeatherTable() {
        ...
        // Insert ContentValues into database and get a row ID back
        Long weatherRowID = db.insert(WeatherEntry.TABLE_NAME,null,testValues);
        assertTrue("Failed to insert data",weatherRowID != -1);
